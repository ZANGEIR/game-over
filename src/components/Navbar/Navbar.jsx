...
export default function Nav({userData ,logOut}) {
  ...
  return (
    <>
    <nav className="Nav Nav-expand-lg Nav-dark bg-dark">
  <div className="container">
  
  
  <img src={IMAGES.Logo}  alt=""  className={styles}/>
    <h5 className="Nav-brand" >Game over</h5>
  
  
    
    <button className="Nav-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#NavSupportedContent" aria-controls="NavSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
      <span className="Nav-toggler-icon" />
    </button>
    <div className="collapse Nav-collapse" id="NavSupportedContent">
     {userData?<><ul className="Nav-nav me-auto mb-2 mb-lg-0">
  ...
  <ul className="dropdown-menu bg-dark ">
    ...
    <li><NavLink className="dropdown-item bg-transparent text-white" to={`category/battle-royale`}>battle-royal</NavLink></li>
      ...
      <ul className="Nav-nav ms-auto mb-2 mb-lg-0">
        {userData?
          <li className="nav-item">
