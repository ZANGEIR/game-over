...
const [moreItem, setMoreItem] = useState(10)
const options = {
  method: 'GET',
...
<div className="row gy-3 pt-5">
  ...
  <button className='btn btn-secondary w-25' onClick={showItems}>More Games</button></div>
</div>
</>
...
{isLoading && (<>
  ...
  <div className="col-md-12">
                ...
                <span className="loade">Load&nbsp;ng</span>
                </div>
              </div>
